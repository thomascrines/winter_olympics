...
team01 = Team.new({'name' => "Canada", 'code' => "CAN", 'flag_url' => "flags/ca.png"})
team01.save()
team02 = Team.new({'name' => "Czech Republic", 'code' => "CZE", 'flag_url' => "flags/cz.png"})
team02.save()
team03 = Team.new({'name' => "Finland", 'code' => "FIN", 'flag_url' => "flags/fi.png"})
team03.save()
team04 = Team.new({'name' => "Germany", 'code' => "GER", 'flag_url' => "flags/de.png"})
team04.save()
team05 = Team.new({'name' => "Norway", 'code' => "NOR", 'flag_url' => "flags/no.png"})
team05.save()
team06 = Team.new({'name' => "Russia", 'code' => "RUS", 'flag_url' => "flags/ru.png"})
team06.save()
team07 = Team.new({'name' => "Slovenia", 'code' => "SLO", 'flag_url' => "flags/si.png"})
team07.save()
team08 = Team.new({'name' => "Slovakia", 'code' => "SVK", 'flag_url' => "flags/sk.png"})
team08.save()
team09 = Team.new({'name' => "South Korea", 'code' => "KOR", 'flag_url' => "flags/kr.png"})
team09.save()
team10 = Team.new({'name' => "Sweden", 'code' => "SLO", 'flag_url' => "flags/se.png"})
team10.save()
team11 = Team.new({'name' => "United States", 'code' => "USA", 'flag_url' => "flags/us.png"})
team11.save()
team12 = Team.new({'name' => "Switzerland", 'code' => "SUI", 'flag_url' => "flags/ch.png"})
team12.save()
